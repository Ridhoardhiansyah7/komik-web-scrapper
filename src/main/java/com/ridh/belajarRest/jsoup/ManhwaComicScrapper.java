...
public class ManhwaComicScrapper {

    public static void main(String[] args) throws IOException {

        Document doc = Jsoup.connect(Endpoint.BASE_WEST_MANGA+"manga/?page=2&status=&type=manhwa&order=")
        ...
        driver.get(Endpoint.BASE_WEST_MANGA+"manga/?page=4&status=&type=manhwa&order=");
